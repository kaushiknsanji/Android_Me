...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction()
                .add(R.id.head_container, headFragment) //Embedding the Head - BodyPartFragment
                .add(R.id.body_container, bodyFragment) //Embedding the Body - BodyPartFragment
                .add(R.id.leg_container, legFragment) //Embedding the Leg - BodyPartFragment
                .commit();
