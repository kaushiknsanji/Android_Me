...
public class BodyPartFragment extends Fragment {
    ...
    //List to store the image resources to display in the fragment
    private List<Integer> mImageList;
    //Current Index of the image to display in the fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mImageList != null){
            ...
            //Log a message saying that the image list is null
            Log.v(LOG_TAG, "The Fragment's image list is not initialized");
        }
    ...
    //Setter method to set and store of a list of image resources
    ...
    //Setter method to track and set the index of the list item to display
