...
public class MasterListFragment extends Fragment {
    ...
    /**
     * Default Constructor of the Fragment to instantiate {@link MasterListFragment}
     */
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //Inflating a layout containing a GridView
        ...
        MasterListAdapter listAdapter = new MasterListAdapter(this.getContext(), AndroidImageAssets.getAll());

        //Attaching the above adapter to the GridView to display the images in a Grid
        gridView.setAdapter(listAdapter);

        //Returning the layout prepared
        return rootView;
    }
}
